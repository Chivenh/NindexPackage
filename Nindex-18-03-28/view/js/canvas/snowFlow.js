    ...
    return function (container) {
        ...
        class Snow{
            constructor(){
                ...
                this.y=-1;
                this.maxRadius=randomNUM(3,5);
                this.radius=this.maxRadius/2;
                this.speed=randomNUM(3,7);
                var _deg=randomNUM(10,30)|0;
                this.degs=Doing.degs.map(d=>d+_deg);
                this.draw();
        ...
        class SnowDay {
            constructor(){
                ...
                Tutil.addColor(bgColor,[0,"#1f334d"],[0.2,"#574440"],[0.9,"#caddf0"],[1,"#92cadb"]);
